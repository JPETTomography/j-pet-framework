...
/**
 * @brief Data class representing a reconstructed hit of a photon in the scintillator strip based on Monte Carlo simulation.
 *
 */
...
public:
  ...
  JPetMCHit();
  JPetMCHit(Int_t MCDecayTreeIndex,Int_t MCVtxIndex,float Energy, float Time, TVector3& Position, TVector3& Polarization, TVector3& Momentum);
