...
JPetMCHit::JPetMCHit(Int_t dti,Int_t vi, float e, float t, TVector3& pos, TVector3& pol, TVector3& mom):
 	fMCDecayTreeIndex(dti),fMCVtxIndex(vi), fPolarization(pol),fMomentum(mom)
{
setEnergy(e);
setTime(t);
