//
// File generated by rootcint at Tue Mar 11 21:21:16 2014
...
/* JPetAnalysisModule */
static int G__JPetAnalysisModuleDict_177_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 1:
...
static int G__JPetAnalysisModuleDict_177_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 1:
...
static int G__JPetAnalysisModuleDict_177_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__JPetAnalysisModuleDict_177_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letLonglong(result7, 110, (G__int64) ((JPetAnalysisModule*) G__getstructoffset())->GetEventNb());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetAnalysisModuleDict_177_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__JPetAnalysisModuleDict_177_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) JPetAnalysisModule::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetAnalysisModuleDict_177_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) JPetAnalysisModule::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetAnalysisModuleDict_177_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) JPetAnalysisModule::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetAnalysisModuleDict_177_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__JPetAnalysisModuleDict_177_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__JPetAnalysisModuleDict_177_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) JPetAnalysisModule::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetAnalysisModuleDict_177_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) JPetAnalysisModule::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetAnalysisModuleDict_177_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) JPetAnalysisModule::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetAnalysisModuleDict_177_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__JPetAnalysisModuleDict_177_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__JPetAnalysisModuleDict_177_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memfuncJPetAnalysisModule(void) {
   ...
   G__memfunc_setup("CreateInputObjects",1838,G__JPetAnalysisModuleDict_177_0_3, 121, -1, -1, 0, 1, 1, 1, 0, "C - - 10 '0' inputFilename", (char*)NULL, (void*) NULL, 3);
   G__memfunc_setup("CreateOutputObjects",1967,G__JPetAnalysisModuleDict_177_0_4, 121, -1, -1, 0, 1, 1, 1, 0, "C - - 10 '0' outputFilename", (char*)NULL, (void*) NULL, 3);
   G__memfunc_setup("Exec",389,G__JPetAnalysisModuleDict_177_0_5, 121, -1, -1, 0, 0, 1, 1, 0, "", "called for every event", (void*) NULL, 3);
   G__memfunc_setup("GetEventNb",978,G__JPetAnalysisModuleDict_177_0_6, 110, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 3);
   G__memfunc_setup("Terminate",937,G__JPetAnalysisModuleDict_177_0_7, 121, -1, -1, 0, 0, 1, 1, 0, "", "called once when analysis terminates ", (void*) NULL, 3);
   G__memfunc_setup("Class",502,G__JPetAnalysisModuleDict_177_0_8, 85, G__get_linked_tagnum(&G__JPetAnalysisModuleDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&JPetAnalysisModule::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__JPetAnalysisModuleDict_177_0_9, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&JPetAnalysisModule::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__JPetAnalysisModuleDict_177_0_10, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&JPetAnalysisModule::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__JPetAnalysisModuleDict_177_0_11, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&JPetAnalysisModule::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__JPetAnalysisModuleDict_177_0_15, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__JPetAnalysisModuleDict_177_0_16, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&JPetAnalysisModule::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__JPetAnalysisModuleDict_177_0_17, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&JPetAnalysisModule::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__JPetAnalysisModuleDict_177_0_18, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&JPetAnalysisModule::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__JPetAnalysisModuleDict_177_0_19, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&JPetAnalysisModule::DeclFileLine) ), 0);
   // automatic destructor
   G__memfunc_setup("~JPetAnalysisModule", 1947, G__JPetAnalysisModuleDict_177_0_20, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__JPetAnalysisModuleDict_177_0_21, (int) ('u'), G__get_linked_tagnum(&G__JPetAnalysisModuleDictLN_JPetAnalysisModule), -1, 1, 1, 1, 1, 0, "u 'JPetAnalysisModule' - 11 - -", (char*) NULL, (void*) NULL, 0);
