//
// File generated by rootcint at Tue Mar 11 21:21:26 2014
...
/* JPetPM */
static int G__JPetPMDict_177_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   JPetPM* p = NULL;
...
static int G__JPetPMDict_177_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const JPetPM*) G__getstructoffset())->getSide());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetPMDict_177_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const JPetPM*) G__getstructoffset())->getID());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetPMDict_177_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const JPetPM*) G__getstructoffset())->getHVset());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetPMDict_177_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const JPetPM*) G__getstructoffset())->getHVopt());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetPMDict_177_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 102, (double) ((JPetPM*) G__getstructoffset())->getHVgain((JPetPM::GainNumber) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetPMDict_177_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__JPetPMDict_177_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__JPetPMDict_177_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__JPetPMDict_177_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__JPetPMDict_177_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__JPetPMDict_177_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__JPetPMDict_177_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__JPetPMDict_177_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) JPetPM::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetPMDict_177_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) JPetPM::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetPMDict_177_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) JPetPM::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetPMDict_177_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      JPetPM::Dictionary();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__JPetPMDict_177_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__JPetPMDict_177_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) JPetPM::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetPMDict_177_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) JPetPM::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetPMDict_177_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) JPetPM::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__JPetPMDict_177_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__JPetPMDict_177_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__JPetPMDict_177_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static void G__setup_memfuncJPetPM(void) {
   ...
   G__memfunc_setup("JPetPM",528,G__JPetPMDict_177_0_1, 105, G__get_linked_tagnum(&G__JPetPMDictLN_JPetPM), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getSide",709,G__JPetPMDict_177_0_2, 105, G__get_linked_tagnum(&G__JPetPMDictLN_JPetPMcLcLSide), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getID",461,G__JPetPMDict_177_0_3, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getHVset",810,G__JPetPMDict_177_0_4, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getHVopt",817,G__JPetPMDict_177_0_5, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getHVgain",893,G__JPetPMDict_177_0_6, 102, -1, -1, 0, 1, 1, 1, 0, "i 'JPetPM::GainNumber' - 0 - nr", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getHVgain",893,G__JPetPMDict_177_0_7, 117, G__get_linked_tagnum(&G__JPetPMDictLN_pairlEfloatcOfloatgR), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setSide",721,G__JPetPMDict_177_0_8, 121, -1, -1, 0, 1, 1, 1, 0, "i 'JPetPM::Side' - 0 - side", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setID",473,G__JPetPMDict_177_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - id", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setHVset",822,G__JPetPMDict_177_0_10, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - set", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setHVopt",829,G__JPetPMDict_177_0_11, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - opt", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setHVgain",905,G__JPetPMDict_177_0_12, 121, -1, -1, 0, 2, 1, 1, 0, 
"f - - 0 - g1 f - - 0 - g2", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setHVgain",905,G__JPetPMDict_177_0_13, 121, -1, -1, 0, 1, 1, 1, 0, "u 'pair<float,float>' - 11 - gain", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__JPetPMDict_177_0_14, 85, G__get_linked_tagnum(&G__JPetPMDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&JPetPM::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__JPetPMDict_177_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&JPetPM::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__JPetPMDict_177_0_16, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&JPetPM::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__JPetPMDict_177_0_17, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&JPetPM::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__JPetPMDict_177_0_21, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__JPetPMDict_177_0_22, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&JPetPM::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__JPetPMDict_177_0_23, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&JPetPM::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__JPetPMDict_177_0_24, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&JPetPM::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__JPetPMDict_177_0_25, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&JPetPM::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("JPetPM", 528, G__JPetPMDict_177_0_26, (int) ('i'), G__get_linked_tagnum(&G__JPetPMDictLN_JPetPM), -1, 0, 1, 1, 1, 0, "u 'JPetPM' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~JPetPM", 654, G__JPetPMDict_177_0_27, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
