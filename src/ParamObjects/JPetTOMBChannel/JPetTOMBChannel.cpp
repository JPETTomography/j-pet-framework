...
JPetTOMBChannel::JPetTOMBChannel() { SetName("JPetTOMBChannel"); }

JPetTOMBChannel::JPetTOMBChannel(unsigned int p_channel) : fChannel(p_channel) { SetName("JPetTOMBChannel"); }
...
JPetTOMBChannel::JPetTOMBChannel(bool isNull) : fIsNullObject(isNull) { SetName("JPetTOMBChannel"); }

JPetTOMBChannel::~JPetTOMBChannel() {}

void JPetTOMBChannel::setFEB(JPetFEB& p_FEB) { fFEB = &p_FEB; }

void JPetTOMBChannel::setTRB(JPetTRB& p_TRB) { fTRB = &p_TRB; }

void JPetTOMBChannel::setPM(JPetPM& p_PM) { fPM = &p_PM; }

void JPetTOMBChannel::setThreshold(float p_threshold) { fThreshold = p_threshold; }
...
float JPetTOMBChannel::getThreshold() const { return fThreshold; }

int JPetTOMBChannel::getChannel() const { return fChannel; }

std::string JPetTOMBChannel::getDescription() const { return m_description; }

bool JPetTOMBChannel::operator==(const JPetTOMBChannel& channel) { return getChannel() == channel.getChannel(); }
 ...
 */
unsigned int JPetTOMBChannel::getLocalChannelNumber() const { return fLocalChannelNumber; }

void JPetTOMBChannel::setLocalChannelNumber(unsigned int lcn) { fLocalChannelNumber = lcn; }

/**
 * @brief Get the number of input channel (Numbering starts from 1) of the FEB
 * which corresponds to this TOMB channel.
 */
unsigned int JPetTOMBChannel::getFEBInputNumber() const { return fFEBInputNumber; }

/**
 * @brief Set the number of input channel (Numbering starts from 1) of the FEB
 * which corresponds to this TOMB channel
 */
void JPetTOMBChannel::setFEBInputNumber(unsigned int fin) { fFEBInputNumber = fin; }

bool JPetTOMBChannel::isNullObject() const { return fIsNullObject; }
