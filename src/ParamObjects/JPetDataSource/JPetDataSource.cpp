...
JPetDataSource::JPetDataSource(bool isNull) : fIsNullObject(isNull)
{
  SetName("JPetDataSource");
}
...
{
  return this->getID() == dataSource.getID()
    && this->getType() == dataSource.getType()
    && this->getTBRNetAddress() == dataSource.getTBRNetAddress()
    && this->getHubAddress() == dataSource.getHubAddress();
}
