...
JPetHit JPetGeantParserTools::reconstructHit(JPetMCHit& mcHit, const JPetParamBank& paramBank, const float timeShift, const JPetHitExperimentalParametrizer& parametrizer)
{
