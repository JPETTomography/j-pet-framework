...
void JPetRandom::setGeneratorSeed(unsigned long seed) { fRandomGenerator->SetSeed(seed); }

unsigned long JPetRandom::getGeneratorSeed() { return fRandomGenerator->GetSeed(); }
