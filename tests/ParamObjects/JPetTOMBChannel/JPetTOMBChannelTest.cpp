  ...
  ParamObjectsDescriptions getAllBasicData(ParamObjectType type, const int runId)
  {
    ...
    case ParamObjectType::kTOMBChannel:
      ...
      case 7: // Wrong PM relation
        result = {{1, {{"channel", "1"}, {"local_number", "2"}, {"FEB", "3"}, {"threshold", "4"}}}};
        break;
      case 2: // Simple two objects
        result = {{1, {{"channel", "1"}, {"local_number", "2"}, {"FEB", "3"}, {"threshold", "4"}}},
                  {5, {{"channel", "5"}, {"local_number", "3"}, {"FEB", "4"}, {"threshold", "5"}}}};
        break;
      case 3: // Object with missing field
        result = {{1, {{"channel", "1"}, {"FEB", "3"}, {"threshold", "4"}}}};
        break;
      case 4: // Object with wrong field
        result = {{1, {{"channel", "1"}, {"local_number", "TVP"}, {"FEB", "3"}, {"threshold", "4"}}}};
        break;
      }
      break;
    case ParamObjectType::kPM:
      result = {{1, {{"id", "1"}, {"is_right_side", "1"}, {"description", "no writing"}}}};
      break;
    ...
    case ParamObjectType::kTRB:
      result = {{1, {{"id", "1"}, {"type", "1"}, {"channel", "224"}}}};
      break;
    case ParamObjectType::kScintillator:
      result = {{1, {{"id", "1"}, {"attenuation_length", "10.34"}, {"length", "100"}, {"width", "4.5"}, {"height", "2.5"}}}};
      break;
    case ParamObjectType::kBarrelSlot:
      result = {{1, {{"id", "1"}, {"active", "1"}, {"name", "pepe"}, {"theta1", "5.5"}, {"frame_id", "6"}}}};
      break;
    case ParamObjectType::kLayer:
      result = {{1, {{"id", "1"}, {"active", "1"}, {"name", "ala"}, {"radius", "10.5"}}}};
      break;
    case ParamObjectType::kFrame:
      result = {{1, {{"id", "1"}, {"active", "1"}, {"status", "ok"}, {"description", "descr1"}, {"version", "2"}, {"creator_id", "1"}}}};
      break;
