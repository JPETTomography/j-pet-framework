  ...
  ParamObjectsDescriptions getAllBasicData(ParamObjectType type, const int runId)
  {
    ...
    case ParamObjectType::kScintillator:
      ...
      case 2: // Simple two objects
        result = {{1, {{"id", "1"}, {"attenuation_length", "10.34"}, {"length", "100"}, {"width", "4.5"}, {"height", "2.5"}}},
                  {5, {{"id", "5"}, {"attenuation_length", "11.34"}, {"length", "101"}, {"width", "5.5"}, {"height", "3.5"}}}};
        break;
      case 3: // Object with missing field
        result = {{1, {{"id", "1"}, {"length", "100"}, {"width", "4.5"}, {"height", "2.5"}}}};
        break;
      case 4: // Object with wrong field
        result = {{1, {{"id", "1"}, {"attenuation_length", "none"}, {"length", "100"}, {"width", "4.5"}, {"height", "2.5"}}}};
        break;
      }
      break;
