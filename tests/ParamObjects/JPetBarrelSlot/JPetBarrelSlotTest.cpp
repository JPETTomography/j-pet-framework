...
class TestParamGetter : public JPetParamGetter
{
  ParamObjectsDescriptions getAllBasicData(ParamObjectType type, const int runId)
  {
    ...
    case ParamObjectType::kBarrelSlot:
      ...
      case 2:
        result = {{1, {{"id", "1"}, {"active", "1"}, {"name", "pepe"}, {"theta1", "5.5"}, {"frame_id", "6"}}},
                  {5, {{"id", "5"}, {"active", "0"}, {"name", "smoothface"}, {"theta1", "6.5"}, {"frame_id", "7"}}}};
        break;
      case 3:
        result = {{1, {{"id", "1"}, {"active", "1"}, {"theta1", "5.5"}, {"frame_id", "6"}}}};
        break;
      case 4:
        result = {{1, {{"id", "1"}, {"active", "probably"}, {"name", "pepe"}, {"theta1", "5.5"}, {"frame_id", "6"}}}};
        break;
      }
      break;
