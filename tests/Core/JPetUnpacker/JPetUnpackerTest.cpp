...
struct Fixture
{
  ...
  ~Fixture() { boost::filesystem::remove("xx14099113231.hld.root"); }
};
...
BOOST_FIXTURE_TEST_CASE(my_test3, Fixture)
{
  ...
  unpack.setParams("unitTestData/JPetUnpackerTest/xx14099113231.hld", 10, "unitTestData/JPetUnpackerTest/conf_trb3.xml",
                   "unitTestData/JPetUnpackerTest/calib.root", "unitTestData/JPetUnpackerTest/tdccalib.root");
  BOOST_REQUIRE(unpack.exec());
  BOOST_REQUIRE(unpack.getEventsToProcess() == 10);
...
BOOST_FIXTURE_TEST_CASE(my_test4, Fixture)
{
  ...
  BOOST_REQUIRE(!unpack.exec());
  unpack.setParams("unitTestData/JPetUnpackerTest/xx14099113231.hld", 10, "unitTestData/JPetUnpackerTest/conf_trb3.xml",
                   "unitTestData/JPetUnpackerTest/calib.root");
  BOOST_REQUIRE(unpack.exec());
  unpack.setParams("unitTestData/JPetUnpackerTest/xx14099113231.hld", 10, "unitTestData/JPetUnpackerTest/conf_trb3.xml",
                   "unitTestData/JPetUnpackerTest/calib2.root");
  BOOST_REQUIRE(!unpack.exec());
  unpack.setParams("unitTestData/JPetUnpackerTest/xx14099113231.hld", 10, "unitTestData/JPetUnpackerTest/conf_trb3.xml",
                   "unitTestData/JPetUnpackerTest/calib.root", "unitTestData/JPetUnpackerTest/calib2.root");
  BOOST_REQUIRE(!unpack.exec());
}
