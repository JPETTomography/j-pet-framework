...
DMODULES = JPetAnalysisModule JPetBarrelSlot JPetEvent JPetHit JPetMacroLoader JPetPM JPetScin JPetSigCh JPetSignal JPetTRB JPetTSlot JPetUnpacker JPetFrame JPetFEB JPetLayer JPetSetup JPetSlot JPetTOMB JPetTOMBChannel JPetUser JPetTreeHeader JPetParamBank
DICTS   = $(DMODULES)
