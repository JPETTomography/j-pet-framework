...
DMODULES = JPetAnalysisModule JPetBarrelSlot JPetLOR JPetHit JPetMacroLoader JPetPM JPetScin JPetSigCh JPetBaseSignal JPetRawSignal JPetRecoSignal JPetPhysSignal JPetTRB JPetTimeWindow JPetUnpacker JPetFEB JPetTOMBChannel JPetUser JPetTreeHeader JPetParamBank JPetPMCalib JPetLayer JPetFrame JPetCommonAnalysisModule
DICTS   = $(DMODULES)
READERS = JPetReader JPetHLDReader JPetScopeReader
WRITERS = JPetWriter
#Modules without ROOT dictionnaries
NONDMODULES = DummyClass JPetLogger JPetCmdParser JPetParamManager JPetManager $(READERS) $(WRITERS) JPetDBParamGetter JPetParamUtils JPetAnalysisRunner JPetTask JPetTaskIO JPetAnalysisModuleT JPetCommonAnalysisModuleT JPetTaskOptions JPetOptions
