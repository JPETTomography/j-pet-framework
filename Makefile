...
MODULES = DummyClass JPetLogger JPetManager JPetReader JPetAnalysisModule JPetSignal JPetSigCh JPetTSlot  JPetTSlotUnpReader JPetHit JPetEvent JPetPhysSigReader JPetPhysSigWriter
