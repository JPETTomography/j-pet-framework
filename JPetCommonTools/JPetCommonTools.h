...
public:
  ...
  static std::size_t findSubstring(const std::string &p_string,
  ...
  extractFileNameFromFullPath(const std::string &fileWithPath)
  {
  ...
  static const std::string getMD5FromFile(const std::string filePath,
